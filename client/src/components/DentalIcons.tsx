...
export function CanalIcon(props: IconProps) { return <svg {...base(props)}><path d="M12 9c4-5 9-4 12-2 3-2 8-3 12 2 6 8 0 16-2 23-2 7-5 10-8 2l-2-7-2 7c-3 8-6 5-8-2-2-7-8-15-2-23Z"/><path d="M20 16c1 5 2 12 2 18m4-18c-1 5-2 12-2 18"/></svg>; }
export function SleepIcon(props: IconProps) { return <svg {...base(props)}><path d="M33 8a15 15 0 1 0 7 18 12 12 0 0 1-7-18Z"/><path d="M26 12h7l-7 8h7"/></svg>; }
export function WhiteningIcon(props: IconProps) { return <svg {...base(props)}><path d="M10 13c3-4 7-3 10-1 3-2 7-3 10 1 5 7 0 14-2 20-1 6-4 9-6 2l-2-6-2 6c-2 7-5 4-6-2-2-6-7-13-2-20Z"/><path d="M38 6v8m-4-4h8M40 18v5m-2.5-2.5h5"/></svg>; }
export function ChildIcon(props: IconProps) { return <svg {...base(props)}><path d="M15 14c3-4 6-3 9-1 3-2 6-3 9 1 4 6 0 11-2 16-1 5-3 7-4 1l-3-5-3 5c-1 6-3 4-4-1-2-5-6-10-2-16Z"/><circle cx="20" cy="21" r="1.2" fill="currentColor" stroke="none"/><circle cx="28" cy="21" r="1.2" fill="currentColor" stroke="none"/><path d="M20.5 26c2 1.8 5 1.8 7 0"/></svg>; }
export function PlanIcon(props: IconProps) { return <svg {...base(props)}><path d="M14 9h20a3 3 0 0 1 3 3v27a3 3 0 0 1-3 3H14a3 3 0 0 1-3-3V12a3 3 0 0 1 3-3Z"/><path d="M19 7h10v5H19z"/><path d="m17 23 3 3 6-7"/><path d="M30 33H18m12-6h-2"/></svg>; }
export function ClarityIcon(props: IconProps) { return <svg {...base(props)}><path d="M40 27a4 4 0 0 1-4 4h-5l-8 7v-7h-11a4 4 0 0 1-4-4V13a4 4 0 0 1 4-4h24a4 4 0 0 1 4 4Z"/><path d="M17 17h14m-14 6h9"/></svg>; }

export const dentalIcons = { tooth: ToothIcon, implant: ImplantIcon, smile: SmileIcon, veneer: VeneerIcon, braces: BracesIcon, clock: ClockIcon, graduation: GraduationIcon, shield: ShieldIcon, care: CareIcon, location: LocationIcon, canal: CanalIcon, sleep: SleepIcon, whitening: WhiteningIcon, child: ChildIcon, plan: PlanIcon, clarity: ClarityIcon };
